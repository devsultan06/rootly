...
export default function GetStartedPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Sign up attempt:", { name, email, company, password, agreeTerms });
  };
              ...
              <div className="pt-1.5">
                <label className="flex items-start gap-2.5 cursor-pointer text-[11px] text-muted leading-relaxed">
                  <input
                    ...
                    required
                    className="rounded border-white/10 bg-[#09090B] text-[#14B8A6] focus:ring-0 w-3.5 h-3.5 cursor-pointer mt-0.5 flex-shrink-0"
                  />
                  <span>
                    I agree to the{" "}
