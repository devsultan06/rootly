          ...
          <div className="bg-[#111111] border border-white/5 rounded-xl p-8">
            ...
            <div className="space-y-2">
              <button
                ...
                type="button"
                className="w-full flex items-center justify-center gap-2.5 py-2 px-3 bg-[#09090B] hover:bg-white/[0.02] border border-white/5 hover:border-white/10 rounded-lg text-xs font-medium text-[#F1F1F1] transition-all cursor-pointer"
              >
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  type="button"
                  className="flex items-center justify-center gap-2 py-2 px-3 bg-[#09090B] hover:bg-white/[0.02] border border-white/5 hover:border-white/10 rounded-lg text-xs font-medium text-[#F1F1F1] transition-all cursor-pointer"
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
