    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-sm text-muted mt-1">
          Connect your tools to give Rootly full context across your engineering
          org.
        </p>
      </div>
                  ...
                  <div className="mt-auto pt-1">
                    {integration.connected ? (
                      <div className="flex items-center justify-between">
                        ...
                        <button className="text-xs text-muted hover:text-foreground font-medium transition-colors cursor-pointer bg-transparent border-none">
                          Manage →
                        </button>
                      </div>
                    ) : (
                      <button className="w-full py-2 px-3 rounded-lg text-xs font-semibold bg-accent/10 text-accent border border-accent-border hover:bg-accent hover:text-black transition-all cursor-pointer">
                        Connect
                      </button>
                    )}
                  </div>
